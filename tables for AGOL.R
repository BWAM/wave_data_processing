...
wave_score<-read.csv("C:/Users/sggoodri/OneDrive - New York State Office of Information Technology Services/SMAS - WAVE/2025/wave_data_processing/Outputs/db_tables/MASTER_S_WAVE_ASSESSMENT.csv")
site_info<-read.csv("C:/Users/sggoodri/OneDrive - New York State Office of Information Technology Services/SMAS - WAVE/2025/wave_data_processing/Outputs/db_tables/MASTER_S_WAVE_SAMPLE_EVENT_INFO.csv")
